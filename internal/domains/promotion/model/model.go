...
// DiscountType enum for promotion discount types
...
// Promotion represents a promotional campaign or discount code
...
// PromotionUsage represents a record of promotion being used in an order
...
func (p *Promotion) IsAvailable() bool {
	if !p.IsValid() {
		return false
	}
...
func (p *Promotion) CanBeUsedByUser(userID uuid.UUID, isFirstOrder bool) (bool, error) {
...
func (p *Promotion) CalculateDiscount(orderTotal decimal.Decimal) (decimal.Decimal, error) {
